...
wire   [12:0] i_1_fu_78_p2;
reg   [12:0] i_1_reg_92;
reg    ap_block_state2;
reg    ap_block_state2_io;
wire   [63:0] outWrite_V_fu_84_p1;
reg   [12:0] i_reg_61;
reg    ap_block_state1;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (tmp_fu_72_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (tmp_fu_72_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (tmp_fu_72_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        in_V_V_read = 1'b1;
    end else begin
        in_V_V_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((tmp_fu_72_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (tmp_fu_72_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((out_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0))) & (tmp_fu_72_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((out_V_V_1_ack_in == 1'b0) | ((tmp_fu_72_p2 == 1'd0) & (in_V_V_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_io = ((tmp_fu_72_p2 == 1'd0) & (out_V_V_1_ack_in == 1'b0));
end

assign i_1_fu_78_p2 = (i_reg_61 + 13'd1);

assign outWrite_V_fu_84_p1 = in_V_V_dout;
...
assign tmp_fu_72_p2 = ((i_reg_61 == 13'd4096) ? 1'b1 : 1'b0);
