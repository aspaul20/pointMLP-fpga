...
entity Conv1DMac_new319_zec_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 10; 
...
architecture rtl of Conv1DMac_new319_zec_rom is 
...
entity Conv1DMac_new319_zec is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of Conv1DMac_new319_zec is
    component Conv1DMac_new319_zec_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Conv1DMac_new319_zec_rom_U :  component Conv1DMac_new319_zec_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
