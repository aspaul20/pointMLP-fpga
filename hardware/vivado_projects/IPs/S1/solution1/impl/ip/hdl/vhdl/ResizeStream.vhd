...
architecture behav of ResizeStream is 
    ...
    signal i_1_fu_78_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state2 : BOOLEAN;
    signal i_reg_61 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                i_reg_61 <= i_1_fu_78_p2;
            elsif ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                i_reg_61 <= ap_const_lv11_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, in_V_V_0_vld_out, out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_block_state2_assign_proc : process(in_V_V_0_vld_out, out_V_V_full_n, tmp_fu_72_p2)
    begin
                ap_block_state2 <= (((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)));
    end process;


    ap_done_assign_proc : process(ap_done_reg, in_V_V_0_vld_out, out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    i_1_fu_78_p2 <= std_logic_vector(unsigned(i_reg_61) + unsigned(ap_const_lv11_1));
    in_V_V_0_ack_in <= in_V_V_0_state(1);

    in_V_V_0_ack_out_assign_proc : process(in_V_V_0_vld_out, out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    in_V_V_TDATA_blk_n_assign_proc : process(in_V_V_0_state, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
    ...
    internal_ap_ready_assign_proc : process(in_V_V_0_vld_out, out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    out_V_V_blk_n_assign_proc : process(out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        if (((tmp_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    out_V_V_write_assign_proc : process(in_V_V_0_vld_out, out_V_V_full_n, ap_CS_fsm_state2, tmp_fu_72_p2)
    begin
        if ((not((((tmp_fu_72_p2 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((tmp_fu_72_p2 = ap_const_lv1_0) and (in_V_V_0_vld_out = ap_const_logic_0)))) and (tmp_fu_72_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    tmp_fu_72_p2 <= "1" when (i_reg_61 = ap_const_lv11_600) else "0";
end behav;
