...
architecture behav of get_random is 
    ...
    constant ap_const_lv31_A6 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000010100110";
    ...
    signal tmp_cast_30_fu_160_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_return_0 <= tmp_cast_30_fu_160_p1;
    ...
    p_cast2_cast_fu_74_p3 <= 
        ap_const_lv12_A6 when (feedback_fu_42_p1(0) = '1') else 
        ap_const_lv12_0;
    p_cast_cast_fu_124_p3 <= 
        ap_const_lv12_69 when (feedback_1_fu_92_p1(0) = '1') else 
        ap_const_lv12_0;
    ...
    tmp_2_i4_cast_cast_c_fu_106_p3 <= 
        ap_const_lv31_69 when (feedback_1_fu_92_p1(0) = '1') else 
        ap_const_lv31_0;
    tmp_2_i_cast_cast_ca_fu_56_p3 <= 
        ap_const_lv31_A6 when (feedback_fu_42_p1(0) = '1') else 
        ap_const_lv31_0;
    tmp_cast_30_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_cast_fu_154_p2),32));
