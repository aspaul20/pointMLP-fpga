...
architecture behav of StreamingDataWidthCo_3 is 
    ...
    signal t_2_fu_137_p2 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal o_2_fu_149_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, exitcond_fu_131_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    ap_condition_56_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_reg_189)
    begin
                ap_condition_56 <= ((exitcond_reg_189 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;
    ...
    ap_phi_mux_p_Val2_s_phi_fu_124_p4_assign_proc : process(in_V_V_dout, tmp_reg_198, ap_phi_reg_pp0_iter1_p_Val2_s_reg_121, p_2_cast_fu_169_p1, ap_condition_56)
    begin
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op23_read_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    o_2_fu_149_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(o_reg_99));
    ...
    p_s_fu_161_p3 <= 
        ...
        o_2_fu_149_p2;
    t_2_fu_137_p2 <= std_logic_vector(unsigned(t_reg_110) + unsigned(ap_const_lv15_1));
    tmp_fu_143_p2 <= "1" when (o_reg_99 = ap_const_lv32_0) else "0";
    tmp_s_fu_155_p2 <= "1" when (o_2_fu_149_p2 = ap_const_lv32_4) else "0";
end behav;
