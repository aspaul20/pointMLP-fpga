...
get_random::get_random(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_cast_30_fu_160_p1 );
    ...
    SC_METHOD(thread_tmp_cast_30_fu_160_p1);
    ...
    sc_trace(mVcdFile, tmp_cast_30_fu_160_p1, "tmp_cast_30_fu_160_p1");
...
void get_random::thread_ap_return_0() {
    ap_return_0 = tmp_cast_30_fu_160_p1.read();
}
...
void get_random::thread_p_cast2_cast_fu_74_p3() {
    p_cast2_cast_fu_74_p3 = (!feedback_fu_42_p1.read()[0].is_01())? sc_lv<12>(): ((feedback_fu_42_p1.read()[0].to_bool())? ap_const_lv12_A6: ap_const_lv12_0);
}

void get_random::thread_p_cast_cast_fu_124_p3() {
    p_cast_cast_fu_124_p3 = (!feedback_1_fu_92_p1.read()[0].is_01())? sc_lv<12>(): ((feedback_1_fu_92_p1.read()[0].to_bool())? ap_const_lv12_69: ap_const_lv12_0);
}
...
void get_random::thread_tmp_2_i4_cast_cast_c_fu_106_p3() {
    tmp_2_i4_cast_cast_c_fu_106_p3 = (!feedback_1_fu_92_p1.read()[0].is_01())? sc_lv<31>(): ((feedback_1_fu_92_p1.read()[0].to_bool())? ap_const_lv31_69: ap_const_lv31_0);
}

void get_random::thread_tmp_2_i_cast_cast_ca_fu_56_p3() {
    tmp_2_i_cast_cast_ca_fu_56_p3 = (!feedback_fu_42_p1.read()[0].is_01())? sc_lv<31>(): ((feedback_fu_42_p1.read()[0].to_bool())? ap_const_lv31_A6: ap_const_lv31_0);
}

void get_random::thread_tmp_cast_30_fu_160_p1() {
    tmp_cast_30_fu_160_p1 = esl_zext<32,12>(tmp_cast_fu_154_p2.read());
}
