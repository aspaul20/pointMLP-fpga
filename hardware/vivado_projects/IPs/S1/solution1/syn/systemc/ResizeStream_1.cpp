...
const sc_lv<3> ResizeStream_1::ap_ST_fsm_state1 = "1";
const sc_lv<3> ResizeStream_1::ap_ST_fsm_state2 = "10";
const sc_lv<3> ResizeStream_1::ap_ST_fsm_state3 = "100";
...
const sc_lv<2> ResizeStream_1::ap_const_lv2_0 = "00";
const sc_lv<2> ResizeStream_1::ap_const_lv2_2 = "10";
const sc_lv<2> ResizeStream_1::ap_const_lv2_3 = "11";
const sc_lv<2> ResizeStream_1::ap_const_lv2_1 = "1";
const sc_lv<32> ResizeStream_1::ap_const_lv32_1 = "1";
const sc_lv<32> ResizeStream_1::ap_const_lv32_2 = "10";
const sc_lv<13> ResizeStream_1::ap_const_lv13_0 = "0000000000000";
const sc_lv<13> ResizeStream_1::ap_const_lv13_1000 = "1000000000000";
const sc_lv<13> ResizeStream_1::ap_const_lv13_1 = "1";
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state2_io.read())) && 
                    esl_seteq<1,1,1>(ap_const_lv1_1, tmp_fu_72_p2.read()))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(out_V_V_1_ack_in.read(), ap_const_logic_1))) {
        i_reg_61 = i_1_reg_92.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        i_reg_61 = ap_const_lv13_0;
    }
    if ( ap_rst.read() == ap_const_logic_1) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && !((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state2_io.read())))) {
...
void ResizeStream_1::thread_ap_CS_fsm_state3() {
...
void ResizeStream_1::thread_ap_block_state2() {
    ap_block_state2 = ((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()));
}

void ResizeStream_1::thread_ap_block_state2_io() {
    ap_block_state2_io = (esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()));
}
...
void ResizeStream_1::thread_i_1_fu_78_p2() {
    i_1_fu_78_p2 = (!i_reg_61.read().is_01() || !ap_const_lv13_1.is_01())? sc_lv<13>(): (sc_biguint<13>(i_reg_61.read()) + sc_biguint<13>(ap_const_lv13_1));
}
...
void ResizeStream_1::thread_outWrite_V_fu_84_p1() {
    outWrite_V_fu_84_p1 = esl_zext<64,32>(in_V_V_dout.read());
}

void ResizeStream_1::thread_out_V_V_1_ack_in() {
    out_V_V_1_ack_in = out_V_V_1_state.read()[1];
}

void ResizeStream_1::thread_out_V_V_1_ack_out() {
    out_V_V_1_ack_out = out_V_V_TREADY.read();
}

void ResizeStream_1::thread_out_V_V_1_data_out() {
...
void ResizeStream_1::thread_out_V_V_1_load_A() {
    out_V_V_1_load_A = (out_V_V_1_state_cmp_full.read() & ~out_V_V_1_sel_wr.read());
}

void ResizeStream_1::thread_out_V_V_1_load_B() {
    out_V_V_1_load_B = (out_V_V_1_sel_wr.read() & out_V_V_1_state_cmp_full.read());
}

void ResizeStream_1::thread_out_V_V_1_sel() {
    out_V_V_1_sel = out_V_V_1_sel_rd.read();
}

void ResizeStream_1::thread_out_V_V_1_state_cmp_full() {
...
void ResizeStream_1::thread_out_V_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
         !((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state2_io.read())))) {
...
void ResizeStream_1::thread_out_V_V_1_vld_out() {
    out_V_V_1_vld_out = out_V_V_1_state.read()[0];
}

void ResizeStream_1::thread_out_V_V_TDATA() {
    out_V_V_TDATA = out_V_V_1_data_out.read();
}

void ResizeStream_1::thread_out_V_V_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read())) || 
...
void ResizeStream_1::thread_out_V_V_TVALID() {
    out_V_V_TVALID = out_V_V_1_state.read()[0];
}

void ResizeStream_1::thread_tmp_fu_72_p2() {
    tmp_fu_72_p2 = (!i_reg_61.read().is_01() || !ap_const_lv13_1000.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_61.read() == ap_const_lv13_1000);
}
...
void ResizeStream_1::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && !((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state2_io.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_fu_72_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && !((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_72_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state2_io.read())))) {
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(out_V_V_1_ack_in.read(), ap_const_logic_1))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
            }
