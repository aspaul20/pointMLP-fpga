...
CloneStream::CloneStream(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_6_fu_117_p2);
    sensitive << ( i_reg_100 );
    ...
    sc_trace(mVcdFile, i_6_fu_117_p2, "i_6_fu_117_p2");
...
void CloneStream::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_111_p2.read()))) {
        i_reg_100 = i_6_fu_117_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_reg_123 = tmp_fu_111_p2.read();
    }
}
...
void CloneStream::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
...
void CloneStream::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, IN_V_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, out1_V_V_full_n.read())) || 
  (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
...
void CloneStream::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, IN_V_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, out1_V_V_full_n.read())) || 
  (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
...
void CloneStream::thread_ap_block_state3_pp0_stage0_iter1() {
    ap_block_state3_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, IN_V_V_empty_n.read())) || (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out1_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_123.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out2_V_V_full_n.read())));
}
...
void CloneStream::thread_i_6_fu_117_p2() {
    i_6_fu_117_p2 = (!i_reg_100.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i_reg_100.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void CloneStream::thread_tmp_fu_111_p2() {
    tmp_fu_111_p2 = (!i_reg_100.read().is_01() || !ap_const_lv11_600.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_100.read() == ap_const_lv11_600);
}
...
void CloneStream::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_fu_111_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_fu_111_p2.read(), ap_const_lv1_1))) {
