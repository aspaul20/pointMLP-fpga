...
architecture behav of Conv1DBuffer_new_2 is 
    ...
    signal ptr_simd_reg_139 : STD_LOGIC_VECTOR (1 downto 0);
    signal indvar_flatten3_reg_151 : STD_LOGIC_VECTOR (13 downto 0);
    signal op1_assign_reg_162 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar_flatten_reg_173 : STD_LOGIC_VECTOR (5 downto 0);
    signal nm_reg_184 : STD_LOGIC_VECTOR (3 downto 0);
    signal ptr_simd4_reg_195 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_fu_206_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state2_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ptr_simd_3_fu_212_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ptr_simd_3_reg_396 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal exitcond_flatten_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal indvar_flatten_next1_fu_247_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_enable_reg_pp1_iter0 : STD_LOGIC := '0';
    signal op1_assign_mid2_fu_311_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal or_cond_mid2_fu_351_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_mid2_fu_359_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal inputBuf_0_V_addr_3_reg_424 : STD_LOGIC_VECTOR (1 downto 0);
    signal ptr_simd_4_fu_372_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal indvar_flatten_next_fu_384_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal inputBuf_0_V_address0 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ap_phi_mux_ptr_simd_phi_fu_143_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_s_fu_218_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_137_fu_367_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal tmp_134_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_135_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_flatten3_fu_259_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ofm_iter_fu_253_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_150_mid1_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal not_exitcond_flatten_fu_287_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_371_fu_299_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_mid_fu_265_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_153_mid_fu_305_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_372_fu_325_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_5_fu_319_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_150_mid2_fu_279_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_152_mid1_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_mid1_fu_345_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_mid_fu_293_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ptr_simd4_mid2_fu_331_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal indvar_flatten_op_fu_378_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    port map (
        ...
        d0 => in_V_V_dout,
        q0 => inputBuf_0_V_q0,
        address1 => inputBuf_0_V_addr_3_reg_424,
    ...
    indvar_flatten3_reg_151_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                ...
                indvar_flatten3_reg_151 <= indvar_flatten_next1_fu_247_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_3_reg_424 <= tmp_137_fu_367_p1(2 - 1 downto 0);
    ...
    exitcond_flatten3_fu_259_p2 <= "1" when (indvar_flatten_reg_173 = ap_const_lv6_18) else "0";
    exitcond_flatten_fu_241_p2 <= "1" when (indvar_flatten3_reg_151 = ap_const_lv14_3000) else "0";
    ...
    indvar_flatten_next1_fu_247_p2 <= std_logic_vector(unsigned(indvar_flatten3_reg_151) + unsigned(ap_const_lv14_1));
    indvar_flatten_next_fu_384_p3 <= 
        ap_const_lv6_1 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        indvar_flatten_op_fu_378_p2;
    indvar_flatten_op_fu_378_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_173) + unsigned(ap_const_lv6_1));

    inputBuf_0_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter0, tmp_s_fu_218_p1, tmp_137_fu_367_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_137_fu_367_p1(2 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            inputBuf_0_V_address0 <= tmp_s_fu_218_p1(2 - 1 downto 0);
        else 
    ...
    nm_5_fu_319_p2 <= std_logic_vector(unsigned(nm_mid_fu_265_p3) + unsigned(ap_const_lv4_1));
    nm_mid2_fu_359_p3 <= 
        nm_5_fu_319_p2 when (tmp_153_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_265_p3;
    nm_mid_fu_265_p3 <= 
        ap_const_lv4_0 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        nm_reg_184;
    not_exitcond_flatten_fu_287_p2 <= (exitcond_flatten3_fu_259_p2 xor ap_const_lv1_1);
    ofm_iter_fu_253_p2 <= std_logic_vector(unsigned(op1_assign_reg_162) + unsigned(ap_const_lv10_1));
    op1_assign_mid2_fu_311_p3 <= 
        ofm_iter_fu_253_p2 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        op1_assign_reg_162;
    or_cond_fu_235_p2 <= (tmp_135_fu_229_p2 and tmp_134_fu_223_p2);
    or_cond_mid1_fu_345_p2 <= (tmp_152_mid1_fu_339_p2 and tmp_150_mid2_fu_279_p3);
    or_cond_mid2_fu_351_p3 <= 
        or_cond_mid1_fu_345_p2 when (tmp_153_mid_fu_305_p2(0) = '1') else 
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv2_0 when (tmp_372_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ptr_simd_3_fu_212_p2 <= std_logic_vector(unsigned(ap_phi_mux_ptr_simd_phi_fu_143_p4) + unsigned(ap_const_lv2_1));
    ptr_simd_4_fu_372_p2 <= std_logic_vector(unsigned(ptr_simd4_mid2_fu_331_p3) + unsigned(ap_const_lv2_1));
    ...
    tmp_134_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_135_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv4_7) else "0";
    tmp_137_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_150_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_253_p2) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_150_mid2_fu_279_p3 <= 
        tmp_150_mid1_fu_273_p2 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        tmp_134_fu_223_p2;
    tmp_152_mid1_fu_339_p2 <= "1" when (nm_5_fu_319_p2 = ap_const_lv4_7) else "0";
    tmp_153_mid_fu_305_p2 <= (tmp_371_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_371_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv2_3) else "0";
    tmp_372_fu_325_p2 <= (tmp_153_mid_fu_305_p2 or exitcond_flatten3_fu_259_p2);
    tmp_fu_206_p2 <= "1" when (ap_phi_mux_ptr_simd_phi_fu_143_p4 = ap_const_lv2_3) else "0";
