...
reg    out_V_V_blk_n;
reg   [0:0] exitcond_flatten9_reg_401;
reg   [6:0] ptr_simd_reg_139;
reg   [18:0] indvar_flatten9_reg_151;
reg   [8:0] op1_assign_reg_162;
...
wire   [0:0] exitcond_flatten9_fu_241_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [18:0] indvar_flatten_next9_fu_247_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [8:0] op1_assign_mid2_fu_311_p3;
...
wire   [63:0] tmp_126_fu_367_p1;
reg    ap_block_pp1_stage0_01001;
wire   [0:0] tmp_123_fu_223_p2;
wire   [0:0] tmp_124_fu_229_p2;
wire   [0:0] exitcond_flatten_fu_259_p2;
wire   [8:0] ofm_iter_fu_253_p2;
wire   [0:0] tmp_138_mid1_fu_273_p2;
wire   [0:0] or_cond_fu_235_p2;
wire   [0:0] not_exitcond_flatten_fu_287_p2;
wire   [0:0] tmp_365_fu_299_p2;
wire   [4:0] nm_mid_fu_265_p3;
wire   [0:0] tmp_141_mid_fu_305_p2;
wire   [0:0] tmp_366_fu_325_p2;
wire   [4:0] nm_3_fu_319_p2;
wire   [0:0] tmp_138_mid2_fu_279_p3;
wire   [0:0] tmp_140_mid1_fu_339_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        indvar_flatten9_reg_151 <= 19'd0;
    end else if (((exitcond_flatten9_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten9_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        inputBuf_0_V_addr_1_reg_424 <= tmp_126_fu_367_p1;
...
always @ (*) begin
    if ((exitcond_flatten9_fu_241_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        inputBuf_0_V_address0 = tmp_126_fu_367_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten9_reg_401 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((exitcond_flatten9_reg_401 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        out_V_V_write = 1'b1;
    end else begin
        out_V_V_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond_flatten9_fu_241_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond_flatten9_fu_241_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten9_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten9_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten9_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((exitcond_flatten9_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0)));
end
...
assign exitcond_flatten9_fu_241_p2 = ((indvar_flatten9_reg_151 == 19'd262144) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_259_p2 = ((indvar_flatten_reg_173 == 12'd1024) ? 1'b1 : 1'b0);

assign indvar_flatten_next9_fu_247_p2 = (indvar_flatten9_reg_151 + 19'd1);

assign indvar_flatten_next_fu_384_p3 = ((exitcond_flatten_fu_259_p2[0:0] === 1'b1) ? 12'd1 : indvar_flatten_op_fu_378_p2);

assign indvar_flatten_op_fu_378_p2 = (indvar_flatten_reg_173 + 12'd1);

assign nm_3_fu_319_p2 = (nm_mid_fu_265_p3 + 5'd1);

assign nm_mid2_fu_359_p3 = ((tmp_141_mid_fu_305_p2[0:0] === 1'b1) ? nm_3_fu_319_p2 : nm_mid_fu_265_p3);

assign nm_mid_fu_265_p3 = ((exitcond_flatten_fu_259_p2[0:0] === 1'b1) ? 5'd0 : nm_reg_184);

assign not_exitcond_flatten_fu_287_p2 = (exitcond_flatten_fu_259_p2 ^ 1'd1);

assign ofm_iter_fu_253_p2 = (op1_assign_reg_162 + 9'd1);

assign op1_assign_mid2_fu_311_p3 = ((exitcond_flatten_fu_259_p2[0:0] === 1'b1) ? ofm_iter_fu_253_p2 : op1_assign_reg_162);

assign or_cond_fu_235_p2 = (tmp_124_fu_229_p2 & tmp_123_fu_223_p2);

assign or_cond_mid1_fu_345_p2 = (tmp_140_mid1_fu_339_p2 & tmp_138_mid2_fu_279_p3);

assign or_cond_mid2_fu_351_p3 = ((tmp_141_mid_fu_305_p2[0:0] === 1'b1) ? or_cond_mid1_fu_345_p2 : or_cond_mid_fu_293_p2);

assign or_cond_mid_fu_293_p2 = (or_cond_fu_235_p2 & not_exitcond_flatten_fu_287_p2);

assign out_V_V_din = inputBuf_0_V_q0;

assign ptr_simd4_mid2_fu_331_p3 = ((tmp_366_fu_325_p2[0:0] === 1'b1) ? 7'd0 : ptr_simd4_reg_195);
...
assign tmp_123_fu_223_p2 = ((op1_assign_reg_162 < 9'd255) ? 1'b1 : 1'b0);

assign tmp_124_fu_229_p2 = ((nm_reg_184 == 5'd15) ? 1'b1 : 1'b0);

assign tmp_126_fu_367_p1 = ptr_simd4_mid2_fu_331_p3;

assign tmp_138_mid1_fu_273_p2 = ((ofm_iter_fu_253_p2 < 9'd255) ? 1'b1 : 1'b0);

assign tmp_138_mid2_fu_279_p3 = ((exitcond_flatten_fu_259_p2[0:0] === 1'b1) ? tmp_138_mid1_fu_273_p2 : tmp_123_fu_223_p2);

assign tmp_140_mid1_fu_339_p2 = ((nm_3_fu_319_p2 == 5'd15) ? 1'b1 : 1'b0);

assign tmp_141_mid_fu_305_p2 = (tmp_365_fu_299_p2 & not_exitcond_flatten_fu_287_p2);

assign tmp_365_fu_299_p2 = ((ptr_simd4_reg_195 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_366_fu_325_p2 = (tmp_141_mid_fu_305_p2 | exitcond_flatten_fu_259_p2);

assign tmp_fu_206_p2 = ((ap_phi_mux_ptr_simd_phi_fu_143_p4 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_s_fu_218_p1 = ptr_simd_reg_139;

endmodule //Conv1DBuffer_new326
