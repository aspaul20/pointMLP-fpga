...
architecture behav of computeS4_3 is 
    ...
    "computeS4_3,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z045ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.198500,HLS_SYN_LAT=2637844,HLS_SYN_TPT=2097413,HLS_SYN_MEM=63,HLS_SYN_DSP=0,HLS_SYN_FF=1637,HLS_SYN_LUT=6626,HLS_VERSION=2018_2}";
    ...
    component computeS4_3_control_s_axi IS
    generic (
...
begin
    computeS4_3_control_s_axi_U : component computeS4_3_control_s_axi
    generic map (
