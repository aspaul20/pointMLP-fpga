...
const sc_lv<6> ResizeStream::ap_const_lv6_0 = "000000";
const sc_lv<6> ResizeStream::ap_const_lv6_28 = "101000";
const sc_lv<6> ResizeStream::ap_const_lv6_1 = "1";
...
void ResizeStream::thread_i_1_fu_78_p2() {
    i_1_fu_78_p2 = (!i_reg_61.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_reg_61.read()) + sc_biguint<6>(ap_const_lv6_1));
}
...
void ResizeStream::thread_tmp_fu_72_p2() {
    tmp_fu_72_p2 = (!i_reg_61.read().is_01() || !ap_const_lv6_28.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_61.read() == ap_const_lv6_28);
}
