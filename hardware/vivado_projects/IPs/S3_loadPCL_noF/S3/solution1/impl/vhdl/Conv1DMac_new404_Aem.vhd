...
entity Conv1DMac_new404_Aem_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 14; 
...
architecture rtl of Conv1DMac_new404_Aem_rom is 
...
entity Conv1DMac_new404_Aem is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of Conv1DMac_new404_Aem is
    component Conv1DMac_new404_Aem_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Conv1DMac_new404_Aem_rom_U :  component Conv1DMac_new404_Aem_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
