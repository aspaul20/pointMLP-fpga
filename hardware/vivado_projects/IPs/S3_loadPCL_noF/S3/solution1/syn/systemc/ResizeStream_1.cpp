...
const sc_lv<15> ResizeStream_1::ap_const_lv15_0 = "000000000000000";
const sc_lv<15> ResizeStream_1::ap_const_lv15_4000 = "100000000000000";
const sc_lv<15> ResizeStream_1::ap_const_lv15_1 = "1";
...
void ResizeStream_1::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
        } else if ((esl_seteq<1,1,1>(tmp_fu_62_p2.read(), ap_const_lv1_1) && 
...
void ResizeStream_1::thread_ap_block_state3() {
...
void ResizeStream_1::thread_ap_done() {
    if ((esl_seteq<1,1,1>(tmp_fu_62_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void ResizeStream_1::thread_i_2_fu_68_p2() {
...
void ResizeStream_1::thread_in_V_V_0_ack_in() {
    in_V_V_0_ack_in = in_V_V_0_state.read()[1];
}

void ResizeStream_1::thread_in_V_V_0_ack_out() {
    if ((!(esl_seteq<1,1,1>(in_V_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(out_V_V_full_n.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
...
void ResizeStream_1::thread_in_V_V_0_data_out() {
...
void ResizeStream_1::thread_in_V_V_0_load_A() {
    in_V_V_0_load_A = (in_V_V_0_state_cmp_full.read() & ~in_V_V_0_sel_wr.read());
}

void ResizeStream_1::thread_in_V_V_0_load_B() {
    in_V_V_0_load_B = (in_V_V_0_sel_wr.read() & in_V_V_0_state_cmp_full.read());
}

void ResizeStream_1::thread_in_V_V_0_sel() {
    in_V_V_0_sel = in_V_V_0_sel_rd.read();
}

void ResizeStream_1::thread_in_V_V_0_state_cmp_full() {
...
void ResizeStream_1::thread_in_V_V_0_vld_in() {
    in_V_V_0_vld_in = in_V_V_TVALID.read();
}

void ResizeStream_1::thread_in_V_V_0_vld_out() {
    in_V_V_0_vld_out = in_V_V_0_state.read()[0];
}

void ResizeStream_1::thread_in_V_V_TDATA_blk_n() {
...
void ResizeStream_1::thread_in_V_V_TREADY() {
...
void ResizeStream_1::thread_tmp_fu_62_p2() {
...
void ResizeStream_1::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(tmp_fu_62_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
