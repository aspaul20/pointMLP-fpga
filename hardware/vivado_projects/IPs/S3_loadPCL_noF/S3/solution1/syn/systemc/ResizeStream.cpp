...
void ResizeStream::thread_i_2_fu_68_p2() {
    i_2_fu_68_p2 = (!i_reg_51.read().is_01() || !ap_const_lv19_1.is_01())? sc_lv<19>(): (sc_biguint<19>(i_reg_51.read()) + sc_biguint<19>(ap_const_lv19_1));
}
...
void ResizeStream::thread_tmp_fu_62_p2() {
    tmp_fu_62_p2 = (!i_reg_51.read().is_01() || !ap_const_lv19_40000.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_51.read() == ap_const_lv19_40000);
}
