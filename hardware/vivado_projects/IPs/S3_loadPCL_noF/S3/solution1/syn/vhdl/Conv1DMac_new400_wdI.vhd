...
entity Conv1DMac_new400_wdI_rom is 
    generic(
             DWIDTH     : integer := 5; 
             AWIDTH     : integer := 14; 
...
architecture rtl of Conv1DMac_new400_wdI_rom is 
...
entity Conv1DMac_new400_wdI is
    generic (
        DataWidth : INTEGER := 5;
...
architecture arch of Conv1DMac_new400_wdI is
    component Conv1DMac_new400_wdI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Conv1DMac_new400_wdI_rom_U :  component Conv1DMac_new400_wdI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
