...
architecture behav of computeS4_1 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "computeS4_1,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z045ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.198500,HLS_SYN_LAT=25689612,HLS_SYN_TPT=16777733,HLS_SYN_MEM=81,HLS_SYN_DSP=0,HLS_SYN_FF=1628,HLS_SYN_LUT=6368,HLS_VERSION=2018_2}";
    ...
    signal Relu1D73_U0_ap_start : STD_LOGIC;
    signal Relu1D73_U0_ap_done : STD_LOGIC;
    signal Relu1D73_U0_ap_continue : STD_LOGIC;
    signal Relu1D73_U0_ap_idle : STD_LOGIC;
    signal Relu1D73_U0_ap_ready : STD_LOGIC;
    signal Relu1D73_U0_start_out : STD_LOGIC;
    signal Relu1D73_U0_start_write : STD_LOGIC;
    signal Relu1D73_U0_in_V_V_read : STD_LOGIC;
    signal Relu1D73_U0_out_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Relu1D73_U0_out_V_V_write : STD_LOGIC;
    ...
    signal start_for_Relu1D73_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Relu1D73_U0_full_n : STD_LOGIC;
    signal start_for_Relu1D73_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Relu1D73_U0_empty_n : STD_LOGIC;
    ...
    component start_for_Conv1DMncg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Relu1D7ocq IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_StreamipcA IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Conv1DBqcK IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Conv1DMrcU IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Streamisc4 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_ResizeStde IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component computeS4_1_control_s_axi IS
    generic (
...
begin
    computeS4_1_control_s_axi_U : component computeS4_1_control_s_axi
    generic map (
    ...
    port map (
        ...
        start_full_n => start_for_Relu1D73_U0_full_n,
    ...
    Relu1D73_U0 : component Relu1D73
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Relu1D73_U0_ap_start,
        start_full_n => start_for_StreamingDataWidthCo_U0_full_n,
        ap_done => Relu1D73_U0_ap_done,
        ap_continue => Relu1D73_U0_ap_continue,
        ap_idle => Relu1D73_U0_ap_idle,
        ap_ready => Relu1D73_U0_ap_ready,
        start_out => Relu1D73_U0_start_out,
        start_write => Relu1D73_U0_start_write,
        in_V_V_dout => cnv_89PRL_V_V_dout,
        in_V_V_empty_n => cnv_89PRL_V_V_empty_n,
        in_V_V_read => Relu1D73_U0_in_V_V_read,
        out_V_V_din => Relu1D73_U0_out_V_V_din,
        out_V_V_full_n => cnv_90PRL_V_V_full_n,
        out_V_V_write => Relu1D73_U0_out_V_V_write);
    ...
    port map (
        ...
        if_read => Relu1D73_U0_in_V_V_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Relu1D73_U0_out_V_V_din,
        if_full_n => cnv_90PRL_V_V_full_n,
        if_write => Relu1D73_U0_out_V_V_write,
    ...
    start_for_Conv1DMncg_U : component start_for_Conv1DMncg
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Relu1D7ocq_U : component start_for_Relu1D7ocq
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Relu1D73_U0_din,
        if_full_n => start_for_Relu1D73_U0_full_n,
        if_write => Conv1DMac_new_U0_start_write,
        if_dout => start_for_Relu1D73_U0_dout,
        if_empty_n => start_for_Relu1D73_U0_empty_n,
        if_read => Relu1D73_U0_ap_ready);

    start_for_StreamipcA_U : component start_for_StreamipcA
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_write => Relu1D73_U0_start_write,
    ...
    start_for_Conv1DBqcK_U : component start_for_Conv1DBqcK
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Conv1DMrcU_U : component start_for_Conv1DMrcU
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Streamisc4_U : component start_for_Streamisc4
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ResizeStde_U : component start_for_ResizeStde
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Relu1D73_U0_ap_start <= start_for_Relu1D73_U0_empty_n;
    ...
    ap_done <= ResizeStream_U0_ap_done;
    ap_idle <= (StreamingDataWidthCo_U0_ap_idle and StreamingDataWidthCo_1_U0_ap_idle and ResizeStream_U0_ap_idle and ResizeStream_1_U0_ap_idle and Relu1D_U0_ap_idle and Relu1D73_U0_ap_idle and Conv1DMac_new_U0_ap_idle and Conv1DMac_new_1_U0_ap_idle and Conv1DBuffer_new_U0_ap_idle and Conv1DBuffer_new_1_U0_ap_idle);
    ap_ready <= ResizeStream_1_U0_ap_ready;
    ...
    start_for_Relu1D73_U0_din <= (0=>ap_const_logic_1, others=>'-');
