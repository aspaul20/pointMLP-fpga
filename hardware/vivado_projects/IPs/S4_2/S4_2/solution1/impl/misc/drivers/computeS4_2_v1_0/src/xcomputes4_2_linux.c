...
typedef struct {
    ...
    XComputes4_2_uio_map maps[ MAX_UIO_MAPS ];
} XComputes4_2_uio_info;

/***************** Variable Definitions **************************************/
static XComputes4_2_uio_info uio_info;
...
static int uio_info_read_name(XComputes4_2_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XComputes4_2_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XComputes4_2_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XComputes4_2_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XComputes4_2_Initialize(XComputes4_2 *InstancePtr, const char* InstanceName) {
	XComputes4_2_uio_info *InfoPtr = &uio_info;
