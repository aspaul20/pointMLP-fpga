...
entity Conv1DMac_new398_wdI_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 12; 
...
architecture rtl of Conv1DMac_new398_wdI_rom is 
...
entity Conv1DMac_new398_wdI is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of Conv1DMac_new398_wdI is
    component Conv1DMac_new398_wdI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Conv1DMac_new398_wdI_rom_U :  component Conv1DMac_new398_wdI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
