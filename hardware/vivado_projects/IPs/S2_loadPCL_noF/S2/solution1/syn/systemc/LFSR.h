...
struct LFSR : public sc_module {
    ...
    sc_out< sc_lv<32> > sampleStream_V_din;
    sc_in< sc_logic > sampleStream_V_full_n;
    sc_out< sc_logic > sampleStream_V_write;
    ...
    sc_signal< sc_logic > sampleStream_V_blk_n;
    ...
    sc_signal< sc_lv<32> > reg_58;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > reg_63;
    sc_signal< sc_lv<32> > tmp_267_reg_72;
    sc_signal< sc_logic > grp_get_random_fu_29_ap_ready;
    sc_signal< sc_lv<32> > grp_get_random_fu_29_lfsr31_read;
    sc_signal< sc_lv<32> > grp_get_random_fu_29_lfsr32_read;
    sc_signal< sc_lv<32> > grp_get_random_fu_29_ap_return_0;
    sc_signal< sc_lv<32> > grp_get_random_fu_29_ap_return_1;
    sc_signal< sc_lv<32> > grp_get_random_fu_29_ap_return_2;
    sc_signal< sc_logic > call_ret_126_get_random_fu_37_ap_ready;
    sc_signal< sc_lv<32> > call_ret_126_get_random_fu_37_ap_return_0;
    sc_signal< sc_lv<32> > call_ret_126_get_random_fu_37_ap_return_1;
    sc_signal< sc_lv<32> > call_ret_126_get_random_fu_37_ap_return_2;
    ...
    void thread_grp_get_random_fu_29_lfsr31_read();
    void thread_grp_get_random_fu_29_lfsr32_read();
    void thread_sampleStream_V_blk_n();
