...
entity loadPCL_pcl_V_8428_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 7; 
             MEM_SIZE    : integer := 96
...
architecture rtl of loadPCL_pcl_V_8428_rom is 
...
architecture arch of loadPCL_pcl_V_8428 is
    component loadPCL_pcl_V_8428_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    loadPCL_pcl_V_8428_rom_U :  component loadPCL_pcl_V_8428_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
