...
entity Conv1DMac_new406_OgC_rom is 
    generic(
             DWIDTH     : integer := 4; 
             AWIDTH     : integer := 12; 
...
architecture rtl of Conv1DMac_new406_OgC_rom is 
...
entity Conv1DMac_new406_OgC is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of Conv1DMac_new406_OgC is
    component Conv1DMac_new406_OgC_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Conv1DMac_new406_OgC_rom_U :  component Conv1DMac_new406_OgC_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
