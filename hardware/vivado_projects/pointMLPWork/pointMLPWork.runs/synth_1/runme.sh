...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_wrapper.tcl
