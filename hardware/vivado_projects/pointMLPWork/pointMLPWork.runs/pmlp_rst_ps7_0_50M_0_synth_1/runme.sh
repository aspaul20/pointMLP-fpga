...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/pmlp_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_rst_ps7_0_50M_0.tcl
