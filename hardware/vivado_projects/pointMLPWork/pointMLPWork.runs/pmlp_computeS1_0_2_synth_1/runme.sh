...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/pmlp_computeS1_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_computeS1_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_computeS1_0_2.tcl
