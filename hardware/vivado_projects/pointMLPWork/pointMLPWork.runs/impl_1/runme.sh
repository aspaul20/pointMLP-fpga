...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmlp_wrapper.tcl -notrace
