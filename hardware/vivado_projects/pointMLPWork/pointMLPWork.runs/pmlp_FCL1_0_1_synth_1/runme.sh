...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/pmlp_FCL1_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_FCL1_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_FCL1_0_1.tcl
