...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/pmlp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_xbar_0.tcl
