...
HD_PWD='C:/Users/efree/Desktop/pointMLPWork/pointMLPWork.runs/pmlp_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmlp_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmlp_processing_system7_0_0.tcl
