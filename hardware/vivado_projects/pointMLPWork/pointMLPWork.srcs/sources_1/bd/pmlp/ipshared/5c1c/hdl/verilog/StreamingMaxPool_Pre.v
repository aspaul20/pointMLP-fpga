...
reg   [0:0] tmp_25_reg_322;
reg   [10:0] indvar_flatten_reg_160;
reg   [6:0] ch4_reg_171;
reg   [6:0] ch6_reg_182;
wire   [6:0] ch_1_fu_199_p2;
wire    ap_CS_fsm_state2;
wire   [0:0] tmp_23_fu_210_p2;
wire    ap_CS_fsm_state4;
wire   [8:0] xp_1_fu_216_p2;
reg   [8:0] xp_1_reg_294;
wire   [0:0] exitcond_flatten_fu_222_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] indvar_flatten_next_fu_228_p2;
reg    ap_enable_reg_pp1_iter0;
reg   [5:0] buf_0_V_addr_2_reg_308;
wire   [6:0] ch_3_fu_253_p2;
wire   [0:0] tmp_25_fu_265_p2;
wire    ap_block_state8_pp2_stage0_iter0;
reg    ap_block_state9_pp2_stage0_iter1;
reg    ap_block_pp2_stage0_11001;
wire   [6:0] ch_2_fu_271_p2;
reg    ap_enable_reg_pp2_iter0;
reg   [5:0] buf_0_V_addr_1_reg_331;
reg    ap_block_pp1_stage0_subdone;
reg    ap_condition_pp1_exit_iter0_state5;
wire    ap_CS_fsm_state7;
reg    ap_block_pp2_stage0_subdone;
reg    ap_condition_pp2_exit_iter0_state8;
reg   [5:0] buf_0_V_address0;
reg    buf_0_V_ce0;
reg    buf_0_V_we0;
wire   [7:0] buf_0_V_q0;
...
wire   [63:0] tmp_29_fu_248_p1;
wire   [63:0] tmp_28_fu_277_p1;
reg    ap_block_pp2_stage0_01001;
wire   [0:0] tmp_30_fu_259_p2;
wire   [0:0] tmp_352_fu_234_p2;
wire   [6:0] ch4_mid2_fu_240_p3;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((tmp_23_fu_210_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((tmp_23_fu_210_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_23_fu_210_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ch4_reg_171 <= 7'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ch6_reg_182 <= 7'd0;
    end else if (((tmp_25_fu_265_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_25_fu_265_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
        buf_0_V_addr_1_reg_331 <= tmp_28_fu_277_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_222_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        buf_0_V_addr_2_reg_308 <= tmp_29_fu_248_p1;
    end
end
...
always @ (*) begin
    if ((tmp_25_fu_265_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((tmp_23_fu_210_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        ...
        buf_0_V_address0 = tmp_29_fu_248_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (1'b1 == ap_CS_fsm_pp2_stage0) & (ap_enable_reg_pp2_iter0 == 1'b1))) begin
        buf_0_V_address1 = tmp_28_fu_277_p1;
...
always @ (*) begin
    if ((((tmp_fu_193_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((tmp_25_reg_322 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0) & (1'b0 == ap_block_pp2_stage0_11001)))) begin
        buf_0_V_we0 = 1'b1;
    end else begin
        buf_0_V_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (tmp_30_fu_259_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        buf_0_V_we1 = 1'b1;
    end else begin
        buf_0_V_we1 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp2_stage0) & (tmp_25_reg_322 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((tmp_25_reg_322 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0) & (1'b0 == ap_block_pp2_stage0_11001))) begin
        out_V_V_write = 1'b1;
    end else begin
        out_V_V_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp2_stage0 : begin
            if (~((ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone) & (tmp_25_fu_265_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp2_stage0;
            end else if (((ap_enable_reg_pp2_iter0 == 1'b1) & (1'b0 == ap_block_pp2_stage0_subdone) & (tmp_25_fu_265_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp2_stage0_01001 = ((tmp_25_reg_322 == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((tmp_25_reg_322 == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((tmp_25_reg_322 == 1'd0) & (out_V_V_full_n == 1'b0) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((tmp_25_reg_322 == 1'd0) & (out_V_V_full_n == 1'b0));
end
...
assign ch4_mid2_fu_240_p3 = ((tmp_352_fu_234_p2[0:0] === 1'b1) ? 7'd0 : ch4_reg_171);

assign ch_1_fu_199_p2 = (ch_reg_138 + 7'd1);

assign ch_2_fu_271_p2 = (ch6_reg_182 + 7'd1);

assign ch_3_fu_253_p2 = (ch4_mid2_fu_240_p3 + 7'd1);

assign exitcond_flatten_fu_222_p2 = ((indvar_flatten_reg_160 == 11'd1024) ? 1'b1 : 1'b0);

assign indvar_flatten_next_fu_228_p2 = (indvar_flatten_reg_160 + 11'd1);

assign out_V_V_din = buf_0_V_q1;

assign start_out = real_start;

assign tmp_23_fu_210_p2 = ((xp_reg_149 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_25_fu_265_p2 = ((ch6_reg_182 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_28_fu_277_p1 = ch6_reg_182;

assign tmp_29_fu_248_p1 = ch4_mid2_fu_240_p3;

assign tmp_30_fu_259_p2 = ((in_V_V_dout > buf_0_V_q0) ? 1'b1 : 1'b0);

assign tmp_352_fu_234_p2 = ((ch4_reg_171 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_fu_193_p2 = ((ch_reg_138 == 7'd64) ? 1'b1 : 1'b0);

assign tmp_s_fu_205_p1 = ch_reg_138;

assign xp_1_fu_216_p2 = (xp_reg_149 + 9'd1);
